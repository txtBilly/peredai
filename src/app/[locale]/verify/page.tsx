...
export default function VerifyPage({
  ...
  if (phase === 'pending') {
    return (
      <main className="mx-auto flex min-h-screen max-w-md flex-col items-center justify-center px-5 py-16 text-center">
        ...
        <h1 className="mb-2 font-display text-2xl text-ink">{v.pendingTitle}</h1>
        <p className="mb-8 text-sm text-muted">{v.pendingBody}</p>
        <button
          onClick={refresh}
          className="w-full rounded-lg border border-black/15 px-5 py-3 text-sm text-ink transition hover:border-black/30"
        >
          {v.refreshCta}
        </button>
      </main>
  ...
  if (phase === 'failed') {
    return (
      <main className="mx-auto flex min-h-screen max-w-md flex-col items-center justify-center px-5 py-16 text-center">
        ...
        <h1 className="mb-2 font-display text-2xl text-ink">{v.failedTitle}</h1>
  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-md flex-col justify-center px-5 py-16">
      <p className="mb-4 text-sm uppercase tracking-wide text-cobalt">Ten2Ten</p>
      <h1 className="mb-2 font-display text-3xl text-ink">{v.title}</h1>
