      ...
      <div className="max-h-[85vh] w-full max-w-lg overflow-y-auto overflow-x-hidden rounded-t-2xl border border-black/10 bg-white p-6 sm:rounded-2xl">
        ...
        <div className="mt-6 flex gap-2.5">
          <button
            ...
            className="flex-1 whitespace-nowrap rounded-lg border border-black/15 px-4 py-2.5 text-sm font-medium text-ink hover:border-black/30"
          >
            {labels.clear}
          </button>
          <button
            ...
            className="flex-1 whitespace-nowrap rounded-lg bg-gradient-cobalt px-4 py-2.5 text-sm font-medium text-white transition hover:brightness-110"
          >
            {labels.apply}
          </button>
        </div>
